...
public class ExtendMethodUC4<T extends Comparable<T>> {
	T first;
	T second;
	T third;
	
	public ExtendMethodUC4(T x, T y, T z) {
		this.first = x;
		this.second = y;
		this.third = z;
	}
	...
	public static void main(String args[]) {
		...
		do {
			...
			case 1:
			{
				...
				System.out.println("Maximum Integer value is : " + new ExtendMethodUC4(first, second, third).maximum());
			...
			case 2:
			{
				...
				System.out.println("Maximum float value is : " + new ExtendMethodUC4(first, second, third).maximum());
				break;
			}
			case 3:
			{
				...
				System.out.println("Maximum String value is : " + new ExtendMethodUC4(first, second,third).maximum());
				break;
			}
			default:
