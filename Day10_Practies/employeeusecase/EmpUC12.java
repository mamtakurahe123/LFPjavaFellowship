...
interface IEWComputation {
	...
	class EmpUC12 implements IEWComputation {
	    // class constants
	    ...
	    {
	    	EmpUC12 emp = new EmpUC12();
	    	emp.addCompany("Flipkart", 4, 30, 100);
	    	emp.addCompany("Amazon", 5, 40, 170);
	    	emp.addCompany("D-Mart", 9, 10, 70);
	    	emp.addCompany("Reliance", 19, 10, 150);
