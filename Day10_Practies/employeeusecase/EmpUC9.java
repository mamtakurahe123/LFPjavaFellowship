...
public class EmpUC9 {
 // Ability to save the Total wage of Each Company
    ...
    EmpUC9(String companyName, int wagePerHr, int maxWorkingDays, int maxWorkingHrs)
    {
    ...
    {
    	EmpUC9 google = new EmpUC9("Flipkart", 8, 20, 100);
    	EmpUC9 microsoft = new EmpUC9("Amazon", 4, 30, 150);
